...
export default function Perfil() {
  ...
  useEffect(() => {}, [photo, nome, login, email]);
    ...
    ImagePicker.launchImageLibrary(options, async response => {
      ...
      if (response.uri) {
        ...
        try {
          ...
          Alert.alert(
            "Carregando",
            "Sua foto está sendo carrega, por favor aguarde."
          );
    ...
    <KeyboardAvoidingView style={globalStyles.container}>
      <ScrollView style={localStyles.containerSCrollView}>
        <View style={localStyles.imageView}>
          ...
          >
            <Image
              source={!photo ? withoutPhoto : { uri: photo }}
              style={localStyles.image}
            />
          </TouchableOpacity>
          {loading ? (
            <ActivityIndicator style={globalStyles.loading} size="large" />
          ) : null}
        </View>
        ...
        <View style={[localStyles.infoContainer, localStyles.buttonSpaccing]}>
          <TouchableOpacity
            style={[
              globalStyles.button,
              editar ? globalStyles.buttonGreen : globalStyles.buttonPurple
            ]}
